...
import tools.Utils;
import tools.heart_rate_monitor.ImageProcessing;
...
public class HeartRateMonitor extends AppCompatActivity {
    ...
    private void initView() {
        ...
        toolbar.setTitle("心率监测");
        setSupportActionBar(toolbar);
        toolbar.setNavigationIcon(R.mipmap.back1);
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new PlayTsSound(HeartRateMonitor.this, R.raw.back);
                Utils.finish(HeartRateMonitor.this);
            }
        });
	}
