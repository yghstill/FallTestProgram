 ...
 */
public class Old_LoginActivity extends AppCompatActivity implements
        CompoundButton.OnCheckedChangeListener {

    private EditText username, password;
    private ImageView mBtnClearUid, mBtnClearPsw, back;
    ...
    //    private String httpurl="http://182.254.137.75:8080/MyService/weblogin.action";
//    private String httpurl = "http://192.168.1.111:8080/JsjService/login.action";
    ...
    private void setOnListener() {
       ...
       */
                ...
                if (dialog == null) {
                    dialog = new ProgressDialog(Old_LoginActivity.this);
                }
                ...
                Thread thread = new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            userService.userLogin(Old_LoginActivity.this, loginName, loginPassword);
        ...
        back.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Old_LoginActivity.this, Loading.class);
        ...
        resign.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(Old_LoginActivity.this,
    ...
    private void initUID() {
        pref = getSharedPreferences("old_user", MODE_PRIVATE);
    ...
    private static class IHandler extends Handler {
        ...
        public IHandler(Old_LoginActivity activity) {
            ...
            switch (flag) {
                case 0:
                    String errorMsg = (String) msg.getData().getSerializable(
                            "ErrorMsg");
                    ((Old_LoginActivity) mActivity.get()).showTip(errorMsg);
                    break;
                case FLAG_LOGIN_SUCCESS:
                    ((Old_LoginActivity) mActivity.get())
